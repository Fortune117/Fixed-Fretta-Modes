...
function GM:Initialize()
	...
	Stains = {}
	StainMats = { surface.GetTextureID( "noxctf/sprite_bloodspray1" ),
	surface.GetTextureID( "noxctf/sprite_bloodspray2" ),
	surface.GetTextureID( "noxctf/sprite_bloodspray3" ),
	surface.GetTextureID( "noxctf/sprite_bloodspray4" ),
	surface.GetTextureID( "noxctf/sprite_bloodspray5" ),
	surface.GetTextureID( "noxctf/sprite_bloodspray6" ),
	surface.GetTextureID( "noxctf/sprite_bloodspray7" ),
	surface.GetTextureID( "noxctf/sprite_bloodspray8" ) }
	...
	surface.CreateFont( "ZONoticeText", {
		font =  "Typenoksidi", 
		size = 20,
		weight = 500,
		antialias = true,
